    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#f8fafc_0%,_#ffffff_45%,_#eef2ff_100%)]">
      <div className="mx-auto flex min-h-screen max-w-7xl gap-6 px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="flex w-full flex-1 flex-col gap-6">
          <header className="flex items-center justify-between rounded-3xl border border-zinc-200 bg-white/80 px-5 py-4 shadow-sm backdrop-blur">
            <div>
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <motion.aside
              className="absolute left-0 top-0 h-full w-72 bg-white p-6 shadow-2xl"
              initial={{ x: "-100%" }}
              animate={{ x: 0 }}
              exit={{ x: "-100%" }}
            ...
            >
              <div className="mb-6 flex items-center justify-between">
                ...
                <button
                  type="button"
                  className="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-zinc-200"
                  onClick={() => setOpen(false)}
