	...
	<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background: #ecfdf5; border-radius: ${CARD_RADIUS}; border: 1px solid #a7f3d0;">
		<tr>
			<td style="padding: 28px 24px;">
				...
				<h1 style="margin: 0 0 16px; font-size: 20px; font-weight: 600; color: ${TEXT_DARK};">Hola, ${p.responsibleName}</h1>
				<p style="margin: 0 0 24px; font-size: 15px; line-height: 1.6; color: ${TEXT_MUTED};">Hemos recibido tu solicitud para <strong style="color: ${TEXT_DARK};">${p.businessName}</strong>.</p>
	...
	<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background: linear-gradient(135deg, #eff6ff 0%, #dbeafe 100%); border-radius: ${CARD_RADIUS}; border: 1px solid #93c5fd;">
		<tr>
			<td style="padding: 32px 24px;">
				...
				<p style="margin: 0 0 24px; font-size: 15px; line-height: 1.6; color: ${TEXT_DARK};"><strong>${p.businessName}</strong> ya está activo.</p>
	...
	<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background: #ffffff; border-radius: ${CARD_RADIUS}; border: 1px solid ${BORDER};">
		<tr>
			<td style="padding: 28px 24px;">
				...
				${p.paymentUrl ? `<table role="presentation" cellspacing="0" cellpadding="0" border="0"><tr><td style="border-radius: 8px; background: #d97706;"><a href="${p.paymentUrl}" target="_blank" style="display: inline-block; padding: 14px 28px; font-size: 15px; font-weight: 600; color: #ffffff; text-decoration: none;">Pagar ahora</a></td></tr></table>` : ""}
			</td>
		</tr>
	</table>`;
	return { subject, html: wrapEmailLayout(content) };
	...
	<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background: #eff6ff; border-radius: ${CARD_RADIUS}; border: 1px solid #93c5fd;">
		<tr>
			<td style="padding: 28px 24px;">
				...
				<h1 style="margin: 0 0 16px; font-size: 20px; font-weight: 600; color: ${TEXT_DARK};">Hola, ${p.responsibleName}</h1>
				<p style="margin: 0 0 18px; font-size: 15px; line-height: 1.6; color: ${TEXT_MUTED};">Ya validamos el pago de <strong style="color: ${TEXT_DARK};">${p.businessName}</strong>. Te contactaremos el <strong style="color: ${TEXT_DARK};">${p.contactDate}</strong> para avisarte que tu pagina esta lista.</p>
	...
	<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background: #fffbeb; border-radius: ${CARD_RADIUS}; border: 1px solid #fcd34d;">
		<tr>
			<td style="padding: 28px 24px;">
				...
				<h1 style="margin: 0 0 16px; font-size: 20px; font-weight: 600; color: ${TEXT_DARK};">Hola, ${p.responsibleName}</h1>
				<p style="margin: 0 0 18px; font-size: 15px; line-height: 1.6; color: ${TEXT_MUTED};">Tal como acordamos, hoy es el seguimiento de <strong style="color: ${TEXT_DARK};">${p.businessName}</strong>. Te contactaremos para confirmar el avance de tu pagina y la entrega final.</p>
...
function buildPlanExpiring(p: PlanExpiringParams): { subject: string; html: string } {
	...
	<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background: #fffbeb; border-radius: ${CARD_RADIUS}; border: 1px solid #fcd34d;">
		<tr>
			<td style="padding: 28px 24px;">
				<h1 style="margin: 0 0 16px; font-size: 20px; font-weight: 600; color: ${TEXT_DARK};">Hola, ${p.responsibleName}</h1>
				<p style="margin: 0 0 24px; font-size: 15px; line-height: 1.6; color: ${TEXT_MUTED};">La suscripción de <strong style="color: ${TEXT_DARK};">${p.businessName}</strong> vence el <strong>${p.expiresAt}</strong>.</p>
				${p.panelUrl ? `<table role="presentation" cellspacing="0" cellpadding="0" border="0"><tr><td style="border-radius: 8px; background: ${BRAND_PRIMARY};"><a href="${p.panelUrl}" target="_blank" style="display: inline-block; padding: 14px 28px; font-size: 15px; font-weight: 600; color: #ffffff; text-decoration: none;">Ir al panel</a></td></tr></table>` : ""}
			</td>
		</tr>
	</table>`;
	return { subject, html: wrapEmailLayout(content) };
	...
	<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background: linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%); border-radius: ${CARD_RADIUS}; border: 1px solid #6ee7b7;">
		<tr>
			<td style="padding: 32px 24px;">
				...
				<p style="margin: 0 0 24px; font-size: 15px; line-height: 1.6; color: ${TEXT_DARK};">La página de <strong>${p.businessName}</strong> ya está configurada.</p>
				<table role="presentation" cellspacing="0" cellpadding="0" border="0"><tr><td style="border-radius: 8px; background: #059669;"><a href="${p.siteUrl}" target="_blank" style="display: inline-block; padding: 14px 28px; font-size: 15px; font-weight: 600; color: #ffffff; text-decoration: none;">Ver mi sitio</a></td></tr></table>
			</td>
		</tr>
	</table>`;
	return { subject, html: wrapEmailLayout(content) };
	...
	<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background: #fef2f2; border-radius: ${CARD_RADIUS}; border: 1px solid #fecaca;">
		<tr>
			<td style="padding: 28px 24px;">
				...
				<p style="margin: 0 0 24px; font-size: 15px; line-height: 1.6; color: ${TEXT_MUTED};">La suscripción de <strong style="color: ${TEXT_DARK};">${p.businessName}</strong> ha sido suspendida.</p>
				${p.panelUrl ? `<table role="presentation" cellspacing="0" cellpadding="0" border="0"><tr><td style="border-radius: 8px; background: #dc2626;"><a href="${p.panelUrl}" target="_blank" style="display: inline-block; padding: 14px 28px; font-size: 15px; font-weight: 600; color: #ffffff; text-decoration: none;">Ir al panel</a></td></tr></table>` : ""}
			</td>
		</tr>
	</table>`;
	return { subject, html: wrapEmailLayout(content) };
	...
	<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background: #ecfdf5; border-radius: ${CARD_RADIUS}; border: 1px solid #a7f3d0;">
		<tr>
			<td style="padding: 28px 24px;">
				...
				<h1 style="margin: 0 0 16px; font-size: 20px; font-weight: 600; color: ${TEXT_DARK};">Hola, ${p.responsibleName}</h1>
				<p style="margin: 0 0 24px; font-size: 15px; line-height: 1.6; color: ${TEXT_MUTED};">La cuenta de <strong style="color: ${TEXT_DARK};">${p.businessName}</strong> ha sido reactivada.</p>
				${p.panelUrl ? `<table role="presentation" cellspacing="0" cellpadding="0" border="0"><tr><td style="border-radius: 8px; background: #059669;"><a href="${p.panelUrl}" target="_blank" style="display: inline-block; padding: 14px 28px; font-size: 15px; font-weight: 600; color: #ffffff; text-decoration: none;">Ir al panel</a></td></tr></table>` : ""}
			</td>
		</tr>
	</table>`;
	return { subject, html: wrapEmailLayout(content) };
